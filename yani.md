...
- add logos to experience, maybe try to incorporate a "timeline?" like maybe toggle full timeline to show like educ, certs, and random stuff like started web dev, first line of code, etc.